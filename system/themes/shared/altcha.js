...
(function () {
  ...
  var altchaLocale =
    { "zh-cn": "zh", "zh-tw": "zh-tw", "en-us": "en" }[appLocale] || "en";
  ...
  customElements.whenDefined("altcha-widget").then(function () {
    // Hide loading indicator now that widget is ready
    var loadingEl = document.getElementById("altcha-loading");
