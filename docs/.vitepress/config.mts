    ...
    root: {
      ...
      themeConfig: {
        nav: [
          ...
          { text: "博客", link: "https://golog.giserlab.cn" },
        ],
        sidebar: {
          "/guide/": [
            {
        ...
        socialLinks: [
          { icon: "github", link: "https://github.com/WShihan/golog" },
        ],
        footer: {
          message: "基于 MIT 许可发布",
    ...
    en: {
      ...
      themeConfig: {
        nav: [
          ...
          { text: "Blog", link: "https://golog.giserlab.cn" },
        ],
        sidebar: {
          "/en/guide/": [
            {
    ...
    "zh-tw": {
      ...
      themeConfig: {
        nav: [
          ...
          { text: "部落格", link: "https://golog.giserlab.cn" },
        ],
        sidebar: {
          "/zh-tw/guide/": [
            {
